...
i_link.dt_selected <- subset(i_link.dt, select = c("Con_BCC.ESM1", "Con_CESM2.WACCM", "Con_CNRM.ESM2.1", "Con_GFDL.ESM4",
         ...
         "Con_UKESM1.0.LL", 'decade', 'state', "county", "statenam", "nhgisnam", "geometry"))

#transpose the table
CMIP6.Con.m  <-
    as.data.table(i_link.dt_selected) %>%
    melt( id.vars = c('decade', 'geometry', 'state', 'county', "statenam", "nhgisnam"),
...
write.csv(cmip6_county_11, "/home/xshan2/HAQ_LAB/xshan2/CIMP6_input_1940/cmip6_1940_county_NHGIS.csv")
