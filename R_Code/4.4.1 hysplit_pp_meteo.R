...
disperseR::create_dirs ('/projects/HAQ_LAB/xshan2/disperseR_Linux/')
#disperseR::create_dirs('/scratch/xshan2/disperseR_Linux/main/process')
...
#unit.facility <- read.csv("/scratch/xshan2/R_Code/disperseR/generator2010_gen.csv") 
unit.facility <- read.csv("/home/xshan2/HAQ_LAB/xshan2/R_Code/powerplant/generator2010_gen.csv")
